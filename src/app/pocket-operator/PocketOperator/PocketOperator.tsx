...
// generate buttons without worrying. lift to constants
const firstFourButtons = [1, 2, 3, 4];
const secondFourButtons = [5, 6, 7, 8];
const thirdFourButtons = [9, 10, 11, 12];
const fourthFourButtons = [13, 14, 15, 16];
...
const PocketOperator = ({
  ...
  const [tumblerALevel, setTumblerALevel] = useState<number>(4);
  const [tumblerBLevel, setTumblerBLevel] = useState<number>(4);

  const location = useLocation();
  const soundSourceUrl = useMemo(
    () =>
      location?.origin
  ...
  // whenever the sounds playing change, play the sounds!
  useEffect(() => {
    ...
    <div className={className}>
      ...
      <div className={classes.buttons}>
        <div className={classes.buttonRow}>
          {firstFourButtons.map((buttonNumber) => (
            <NumberedButton
              key={buttonNumber}
        ...
        <div className={classes.buttonRow}>
          {secondFourButtons.map((buttonNumber) => (
            <NumberedButton
              key={buttonNumber}
              buttonNumber={buttonNumber}
              {...numberedButtonProps}
        ...
        <div className={classes.buttonRow}>
          {thirdFourButtons.map((buttonNumber) => (
            <NumberedButton
              key={buttonNumber}
              buttonNumber={buttonNumber}
              {...numberedButtonProps}
        ...
        <div className={classes.buttonRow}>
          {fourthFourButtons.map((buttonNumber) => (
            <NumberedButton
              key={buttonNumber}
              buttonNumber={buttonNumber}
              {...numberedButtonProps}
